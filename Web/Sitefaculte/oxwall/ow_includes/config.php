...
define('OW_URL_HOME', 'http://127.0.0.1/oxwall/');

define('OW_DB_HOST', 'localhost');
define('OW_DB_PORT', null);
define('OW_DB_USER', 'oxwa991');
define('OW_DB_PASSWORD', 'P9djS.6o!3');
define('OW_DB_NAME', 'oxwa991');
...
define('OW_PASSWORD_SALT', '566e221262763');
